...
class TestPentagonIsland(unittest.TestCase):
    island = None
    position = Mock()
    matching_form = PointOfInterestType.PENTAGON_ISLAND
    ...
    def setUp(self):
        self.island = PentagonIsland(self.matching_color, self.position, self.security_zone)
