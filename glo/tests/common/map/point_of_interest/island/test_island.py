...
from common.map.point_of_interest.island.island import Island
...
class TestIsland(unittest.TestCase):
    ...
    def setUp(self):
        self.island = Island(self.matching_form, self.matching_color, self.position, self.security_zone)
